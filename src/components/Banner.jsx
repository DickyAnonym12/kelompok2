    ...
    <div className="relative flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-50 to-white px-4 sm:px-8 overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-6xl w-full z-10">
        ...
        <div className="space-y-8 text-center md:text-left">
          <h1 className="font-poppins font-extrabold text-6xl sm:text-7xl md:text-8xl lg:text-[94px] text-gray-900 leading-tight uppercase tracking-widest text-center">
          ...
          <p className="text-gray-500 text-xl font-poppins font-normal max-w-md mx-auto md:mx-0">
